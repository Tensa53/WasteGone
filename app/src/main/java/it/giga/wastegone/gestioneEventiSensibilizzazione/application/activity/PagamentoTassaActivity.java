                ...
                if (tassa != null) {
                    ...
                    firebaseTassaDAO.doUpdateTassa(tassa, tassaId)
                            ...
                            .addOnFailureListener(e -> {
                                Toast.makeText(this, "Errore durante l'aggiornamento del database", Toast.LENGTH_SHORT).show();
                            });
                }
            }).addOnFailureListener(e -> {
                Toast.makeText(this, "Errore durante il recupero della tassa", Toast.LENGTH_SHORT).show();
            });
        } else {
